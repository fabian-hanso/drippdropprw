  ...
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-7xl sm:px-6 lg:px-8 overflow-hidden">
        <div className="relative isolate overflow-hidden bg-gray-900 px-6 py-24 shadow-2xl sm:rounded-lg sm:px-24 xl:py-32 ">
          <h2 className="mx-auto max-w-3xl text-center text-4xl font-semibold tracking-tight text-white sm:text-5xl">
            Get your news and discounts
          </h2>
          ...
          >
            ...
            <defs>
              ...
              >
                ...
                <stop offset={1} stopColor="#2b2577" stopOpacity={0} />
              </radialGradient>
            </defs>
          </svg>
        </div>
